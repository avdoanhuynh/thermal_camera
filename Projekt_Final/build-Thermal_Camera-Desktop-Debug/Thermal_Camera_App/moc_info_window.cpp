...
#include "../../Thermal_Camera/Thermal_Camera_App/info_window.h"
...
static const char qt_meta_stringdata_InfoWindow[] = {
    "InfoWindow\0okButtonPushed()\0\0"
    "cancelButtonPushed()\0"
};
...
void InfoWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->okButtonPushed(); break;
        case 1: _t->cancelButtonPushed(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData InfoWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject InfoWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_InfoWindow,
      qt_meta_data_InfoWindow, &staticMetaObjectExtraData }
};
